...
const SearchBar = () => {
  return (
    <section className=" border-primary-border border rounded-full px-5 py-2 lg:w-8/12 xl:w-6/12 w-full font-quicksand min-h-[70px] flex items-center justify-between ">
